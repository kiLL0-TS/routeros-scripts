...
certificate chain.
    ...
    [admin@MikroTik] > / tool fetch "https://github.com/kiLL0-TS/routeros-scripts/tree/master/certs/Let%27s%20Encrypt%20Authority%20X3.pem" dst-path="letsencrypt.pem"
          status: finished
